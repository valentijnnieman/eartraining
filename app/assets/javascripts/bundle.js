...
var notes = {
  ...
  "instrument": "piano",
  "difficulty": "easy",
  "all_notes": [{ "key": "c/4", "duration": "q" }, { "key": "d/4", "duration": "q" }],
  "speed": "1000"
};
var notes2 = {
  "key": "D",
  ...
  "instrument": "piano",
  "difficulty": "easy",
  "all_notes": [{ "key": "d/4", "duration": "q" }, { "key": "f#/4", "duration": "q" }],
  "speed": "1000"
};
var simpleNotes = {
  "key": "C",
  ...
  "instrument": "sine",
  "difficulty": "easy",
  "all_notes": [{ "key": "c/4", "duration": "q" }, { "key": "e/4", "duration": "q" }],
  "speed": "1000"
};
...
},{"./snippet.js":3}],2:[function(require,module,exports){
...
Snippet.prototype.render = function () {
  ...
  for (var i = 0; i < this.notes.all_notes.length; i++) {
    note = new Vex.Flow.StaveNote({ clef: "treble", auto_stem: true, keys: [this.notes.all_notes[i].key], duration: this.notes.all_notes[i].duration }), notesToDraw.push(note);
  }
...
},{"./engine.js":2,"./synth.js":4,"vexflow":5}],4:[function(require,module,exports){
...
},{"./engine.js":2}],5:[function(require,module,exports){
